...
import { Button, Form, FormGroup, Label, Input, Container, Row, Col, Card, CardBody, CardHeader, CardFooter } from 'reactstrap';
                ...
                <Form>
                  ...
                  {step === 2 && (
                      ...
                      <Row>
                        ...
                        <Col md={6}>
                          ...
                          <FormGroup>
                            ...
                            <Button onClick={handleOpenUserModal} color="primary" className="modal-button">
                              Add Team Members
                            </Button>
                                ...
                                inputs.materials.map((material, index) => (
                                  ...
                                  <Button
                                    onClick={() => {
                                      ...
                                      setInputs({ ...inputs, materials: newMaterials });
                                    }}
                                    color="danger"
                                    size="sm"
                                  >
                    ...
                    <Row>
                      ...
                      <Col md={6}>
                        <Button onClick={nextStep} color="primary" className="next-button float-right">
                          Next
                        </Button>
                      </Col>
                    </Row>
                      ...
                      <Col md={12}>
                        <FormGroup className="my-form-group">
                          ...
                          <div className="review-section">
                            ...
                            <p><strong>Team Members:</strong> {teamMembers.map(member => member.name).join(', ')}</p>
                            <p><strong>Materials:</strong> {inputs.materials.map(material => material.name).join(', ')}</p>
                          </div>
                        </FormGroup>
                      </Col>
                    </Row>
